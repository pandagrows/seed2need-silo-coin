...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("seed2need"), "Seed2need");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://seed2need.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/seed2need"));
    BOOST_CHECK(validateURL("https://foo.bar/seed2need/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.seed2need.com"));
