...
#error Client version information missing: version is not defined by seed2need-config.h or in any other way
#endif
...
/**
 * seed2needd-res.rc includes this file, but it cannot cope with real c++ code.
