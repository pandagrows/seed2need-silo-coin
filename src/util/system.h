...
extern const char * const SEED2NEED_CONF_FILENAME;
extern const char * const SEED2NEED_PID_FILENAME;
extern const char * const SEED2NEED_MASTERNODE_CONF_FILENAME;
