...
#ifndef SEED2NEED_WALLET_H
#define SEED2NEED_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_SEED2NEED = 61000, // inherited version..
...
public:
     ...
     * SEED2NEED: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    bool CreateCoinstakeOuts(const CSiloStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
