 ...
 *  A CTxDestination is the internal data type encoded in a SEED2NEED address
 */
...
/**
 * Generate a SEED2NEED scriptPubKey for the given CTxDestination. Returns a P2PKH
