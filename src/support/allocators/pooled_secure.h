...
#ifndef SEED2NEED_SUPPORT_ALLOCATORS_POOLED_SECURE_H
#define SEED2NEED_SUPPORT_ALLOCATORS_POOLED_SECURE_H
...
#endif // SEED2NEED_SUPPORT_ALLOCATORS_POOLED_SECURE_H
