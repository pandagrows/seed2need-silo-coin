 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called SEED2NEED (http://www.seed2need.org),
 * which enables instant payments to anyone, anywhere in the world. SEED2NEED uses peer-to-peer technology to operate
...
bool AppInit(int argc, char* argv[])
{
    ...
    // Parameters
    //
    // If Qt is used, parameters/seed2need.conf are parsed in qt/seed2need.cpp's main()
