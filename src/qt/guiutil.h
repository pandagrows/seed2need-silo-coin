...
/** Utility functions used by the SEED2NEED Qt UI.
 */
namespace GUIUtil
{
...
// Render SEED2NEED addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZsilo = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZsilo = false);
...
// Parse "seed2need:" URI into recipient object, return true on successful parsing
