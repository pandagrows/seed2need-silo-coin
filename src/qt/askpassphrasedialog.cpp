...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            SEED2NEEDGUI* window = static_cast<SEED2NEEDGUI*>(parentWidget());
...
{
    SEED2NEEDGUI* gui = static_cast<SEED2NEEDGUI*>(parentWidget());
...
{
    hide();
    static_cast<SEED2NEEDGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("SEED2NEED will close now to finish the encryption process. "
