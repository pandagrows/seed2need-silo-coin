...
// Copyright (c) 2015-2019 The SEED2NEED Core developers
...
/** SEED2NEED unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    //! Short name
    static QString name(int unit, bool isZsilo = false);
    //! Longer description
    ...
    static QString floorWithUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorStandard, bool cleanRemainderZeros = false, bool isZSILO = false);
    static QString floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorStandard, bool cleanRemainderZeros = false, bool isZSILO = false);
