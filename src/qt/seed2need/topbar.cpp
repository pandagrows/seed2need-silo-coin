...
#include "qt/seed2need/topbar.h"
#include "qt/seed2need/forms/ui_topbar.h"
#include "qt/seed2need/lockunlock.h"
#include "qt/seed2need/qtutils.h"
#include "qt/seed2need/receivedialog.h"
#include "qt/seed2need/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/seed2need/balancebubble.h"
...
TopBar::TopBar(SEED2NEEDGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopSilo, ui->labelAmountTopShieldedSilo}, "amount-small-topbar");
    setCssProperty({ui->labelAmountSilo}, "amount-topbar");
    setCssProperty({ui->labelPendingSilo, ui->labelImmatureSilo}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("SEED2NEED")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // SILO Total
    QString totalSilo = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // SILO
    // Top
    ui->labelAmountTopSilo->setText(totalTransparent);
    ui->labelAmountTopShieldedSilo->setText(totalShielded);
    // Expanded
    ui->labelAmountSilo->setText(totalSilo);
    ui->labelPendingSilo->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureSilo->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
