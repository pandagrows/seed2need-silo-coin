...
#ifndef SEED2NEED_CORE_NEW_GUI_SEED2NEEDGUI_H
#define SEED2NEED_CORE_NEW_GUI_SEED2NEEDGUI_H
...
#include "qt/seed2need/receivewidget.h"
#include "qt/seed2need/addresseswidget.h"
#include "qt/seed2need/coldstakingwidget.h"
#include "qt/seed2need/governancewidget.h"
#include "qt/seed2need/masternodeswidget.h"
#include "qt/seed2need/snackbar.h"
#include "qt/seed2need/settings/settingswidget.h"
...
/**
  SEED2NEED GUI main class. This class represents the main window of the SEED2NEED UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SEED2NEEDGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SEED2NEEDGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~SEED2NEEDGUI();
...
#endif //SEED2NEED_CORE_NEW_GUI_SEED2NEEDGUI_H
