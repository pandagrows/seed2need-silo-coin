...
#include "qt/seed2need/createproposaldialog.h"
#include "qt/seed2need/forms/ui_createproposaldialog.h"

#include "qt/seed2need/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(SEED2NEEDGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 SILO");
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast<SEED2NEEDGUI*>(parent()),
                this
        );
