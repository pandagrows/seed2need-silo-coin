...
#include "qt/seed2need/masternodewizarddialog.h"
#include "qt/seed2need/forms/ui_masternodewizarddialog.h"
    ...
    clientModel(_clientModel)
{
    ...
    ui->labelMessage1a->setText(formatHtmlContent(
                formatParagraph(tr("To create a SEED2NEED Masternode you must dedicate %1 (the unit of SEED2NEED) "
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("6320");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("5020");
    } else {
        ui->lineEditPort->setText("4820");
    }
...
bool MasterNodeWizardDialog::createMN()
{
    ...
    if (lineCopy.size() == 0) {
        lineCopy = "# Masternode config file\n"
                   ...
                   "# Example: mn1 127.0.0.2:4820 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0"
                   "#";
    }
    lineCopy += "\n";
