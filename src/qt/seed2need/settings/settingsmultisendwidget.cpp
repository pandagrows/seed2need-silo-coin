...
#include "qt/seed2need/settings/forms/ui_settingsmultisendwidget.h"
#include "qt/seed2need/settings/settingsmultisenddialog.h"
    ...
    ui(new Ui::SettingsMultisendWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other SEED2NEED addresses after it matures."));
