...
#include "qt/seed2need/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(SEED2NEEDGUI* _window, QWidget *parent) :
