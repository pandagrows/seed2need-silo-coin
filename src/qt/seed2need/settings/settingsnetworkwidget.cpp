...
#include "qt/seed2need/settings/settingsnetworkwidget.h"
#include "qt/seed2need/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/seed2need/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SEED2NEEDGUI* _window, QWidget *parent) :
