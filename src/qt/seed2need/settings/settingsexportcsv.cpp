...
#include "qt/seed2need/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(SEED2NEEDGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("SEED2NEED_tx_csv_export(*.csv)") : tr("SEED2NEED_addresses_csv_export(*.csv)"),
                                        nullptr);
