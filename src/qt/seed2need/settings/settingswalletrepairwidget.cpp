// Copyright (c) 2019-2020 The SEED2NEED Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "qt/seed2need/settings/settingswalletrepairwidget.h"
#include "qt/seed2need/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/seed2need/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SEED2NEEDGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SEED2NEEDGUI::handleRestart()
