...
const QString SEED2NEEDGUI::DEFAULT_WALLET = "~Default";

SEED2NEEDGUI::SEED2NEEDGUI(const NetworkStyle* networkStyle, QWidget* parent) :
        QMainWindow(parent),
        clientModel(0){
...
void SEED2NEEDGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    connect(toggleHideAction, &QAction::triggered, this, &SEED2NEEDGUI::toggleHidden);
 ...
 */
void SEED2NEEDGUI::connectActions()
{
    ...
    connect(topBar, &TopBar::showHide, this, &SEED2NEEDGUI::showHide);
    connect(topBar, &TopBar::themeChanged, this, &SEED2NEEDGUI::changeTheme);
    connect(topBar, &TopBar::onShowHideColdStakingChanged, navMenu, &NavMenuWidget::onShowHideColdStakingChanged);
    connect(settingsWidget, &SettingsWidget::showHide, this, &SEED2NEEDGUI::showHide);
    connect(sendWidget, &SendWidget::showHide, this, &SEED2NEEDGUI::showHide);
    connect(receiveWidget, &ReceiveWidget::showHide, this, &SEED2NEEDGUI::showHide);
    connect(addressesWidget, &AddressesWidget::showHide, this, &SEED2NEEDGUI::showHide);
    connect(masterNodesWidget, &MasterNodesWidget::showHide, this, &SEED2NEEDGUI::showHide);
...
void SEED2NEEDGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
#ifndef Q_OS_MAC
...
void SEED2NEEDGUI::handleRestart(QStringList args)
{
...
void SEED2NEEDGUI::setClientModel(ClientModel* _clientModel)
{
...
void SEED2NEEDGUI::createTrayIconMenu()
{
#ifndef Q_OS_MAC
    ...
    connect(trayIcon, &QSystemTrayIcon::activated, this, &SEED2NEEDGUI::trayIconActivated);
#else
    // Note: On macOS, the Dock icon is used to provide the tray's functionality.
    MacDockIconHandler* dockIconHandler = MacDockIconHandler::instance();
    connect(dockIconHandler, &MacDockIconHandler::dockIconClicked, this, &SEED2NEEDGUI::macosDockIconActivated);
...
#ifndef Q_OS_MAC
void SEED2NEEDGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
#else
void SEED2NEEDGUI::macosDockIconActivated()
 {
     show();
     activateWindow();
 }
...
void SEED2NEEDGUI::changeEvent(QEvent* e)
{
...
void SEED2NEEDGUI::closeEvent(QCloseEvent* event)
{
#ifndef Q_OS_MAC // Ignored on Mac
...
void SEED2NEEDGUI::messageInfo(const QString& text)
{
...
bool SEED2NEEDGUI::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn)
{
...
void SEED2NEEDGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if (!clientModel)
        return;
...
void SEED2NEEDGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void SEED2NEEDGUI::detectShutdown()
{
    if (ShutdownRequested()) {
        if (rpcConsole)
            rpcConsole->hide();
...
void SEED2NEEDGUI::goToDashboard()
{
...
void SEED2NEEDGUI::goToSend()
{
    showTop(sendWidget);
}

void SEED2NEEDGUI::goToAddresses()
{
    showTop(addressesWidget);
}

void SEED2NEEDGUI::goToMasterNodes()
{
...
void SEED2NEEDGUI::goToSettingsInfo()
{
    navMenu->selectSettings();
...
void SEED2NEEDGUI::goToReceive()
{
    showTop(receiveWidget);
}

void SEED2NEEDGUI::openNetworkMonitor()
{
    settingsWidget->openNetworkMonitor();
}

void SEED2NEEDGUI::showTop(QWidget* view)
{
...
void SEED2NEEDGUI::changeTheme(bool isLightTheme)
{
...
void SEED2NEEDGUI::resizeEvent(QResizeEvent* event)
{
    // Parent..
...
bool SEED2NEEDGUI::execDialog(QDialog *dialog, int xDiv, int yDiv)
{
    return openDialogWithOpaqueBackgroundY(dialog, this);
}

void SEED2NEEDGUI::showHide(bool show)
{
...
bool SEED2NEEDGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    // Connect actions..
    connect(walletModel, &WalletModel::message, this, &SEED2NEEDGUI::message);
    connect(masterNodesWidget, &MasterNodesWidget::message, this, &SEED2NEEDGUI::message);
    connect(coldStakingWidget, &ColdStakingWidget::message, this, &SEED2NEEDGUI::message);
    connect(topBar, &TopBar::message, this, &SEED2NEEDGUI::message);
    ...
    connect(dashboard, &DashboardWidget::incomingTransaction, this, &SEED2NEEDGUI::incomingTransaction);

    return true;
}

bool SEED2NEEDGUI::setCurrentWallet(const QString& name)
{
    // Single wallet supported.
    return true;
}

void SEED2NEEDGUI::removeAllWallets()
{
    // Single wallet supported.
}

void SEED2NEEDGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address)
{
...
static bool ThreadSafeMessageBox(SEED2NEEDGUI* gui, const std::string& message, const std::string& caption, unsigned int style)
{
...
void SEED2NEEDGUI::subscribeToCoreSignals()
{
...
void SEED2NEEDGUI::unsubscribeFromCoreSignals()
{
