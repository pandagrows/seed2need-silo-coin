...
#include "qt/seed2need/txviewholder.h"
...
#include "config/seed2need-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalSilo = 0;
    qint64 totalZsilo = 0;
    QList<qreal> valuesSilo;
    QList<qreal> valueszSilo;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(SEED2NEEDGUI* _window);
    ~DashboardWidget();
