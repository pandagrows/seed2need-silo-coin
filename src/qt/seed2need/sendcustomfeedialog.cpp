...
#include "qt/seed2need/sendcustomfeedialog.h"
#include "qt/seed2need/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(SEED2NEEDGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &SEED2NEEDGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
