...
#include "qt/seed2need/forms/ui_masternodeswidget.h"

#include "qt/seed2need/qtutils.h"
#include "qt/seed2need/mnrow.h"
#include "qt/seed2need/mninfodialog.h"
...
MasterNodesWidget::MasterNodesWidget(SEED2NEEDGUI *parent) :
    PWidget(parent),
