...
#ifndef SEED2NEED_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define SEED2NEED_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //SEED2NEED_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
