...
public:
    ...
    /**
     * Amount of seed2need coming in to a transaction
...
// SEED2NEED: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
