...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " seed2need-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  seed2need-tx [options] <hex-tx> [commands]  Update hex-encoded seed2need transaction\n" +
                               "or:     seed2need-tx [options] -create [commands]   Create hex-encoded seed2need transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded seed2need transaction
