...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("Seed2need Core seed2need-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  seed2need-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded seed2need transaction") + "\n" +
                               "  seed2need-tx [options] -create [commands]   " + _("Create hex-encoded seed2need transaction") + "\n" +
                               "\n";
