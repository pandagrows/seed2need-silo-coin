...
The script [extract-osx-sdk.sh](https://github.com/seed2need-project/seed2need/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
seed2need/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/seed2need-project/seed2need/blob/master/doc/README_osx.md) for troubleshooting tips.