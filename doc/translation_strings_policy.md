...
This document provides guidelines for internationalization of the SEED2NEED Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to SEED2NEED network</source>
        <translation>
            <numerusform>%n active connection to SEED2NEED network</numerusform>
            <numerusform>%n active connections to SEED2NEED network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `seed2need_en.ts` remains unchanged.
