SEED2NEED Core version v5.1.0 is now available from:  <https://github.com/seed2need-project/seed2need/releases>
...
- #2170 Better seed2need.conf Masternode data error notification (furszy)
