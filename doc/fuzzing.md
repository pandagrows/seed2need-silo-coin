...
To build SEED2NEED Core using AFL instrumentation (this assumes that the
...
with certain assembly code from SEED2NEED Core's code. See [developer notes on sanitizers](https://github.com/pandagrows/seed2need-farm-coin/blob/master/doc/developer-notes.md#sanitizers)
