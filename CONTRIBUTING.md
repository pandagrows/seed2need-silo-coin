Contributing to SEED2NEED Core
============================

The SEED2NEED Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/seed2need-project/seed2need/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SEED2NEED Core project, and is not to be
confused with overall SEED2NEED Network Protocol consensus changes.

Whether a pull request is merged into SEED2NEED Core rests with the project merge
...
Patches that change SEED2NEED consensus rules are considerably more involved than
...
Where a patchset proposes to change the SEED2NEED consensus, it must have been
...
The project leader is the release manager for each SEED2NEED Core release.
