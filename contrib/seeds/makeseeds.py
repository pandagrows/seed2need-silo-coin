...
PATTERN_AGENT = re.compile(r"^/SEED2NEEDCore:5.4.0")
...
def main():
    ...
    # Filter out hosts with multiple seed2need ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple seed2need ports' % (ip_stats(ips)), file=sys.stderr)
