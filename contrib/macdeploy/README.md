...
When complete, it will have produced `SEED2NEED-Core.dmg`.
...
the file-order will change between invocations. The patch can be seen here: [cdrkit-deterministic.patch](https://github.com/seed2need-project/seed2need/blob/master/depends/patches/native_cdrkit/cdrkit-deterministic.patch).
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/seed2need-project/seed2need-detached-sigs).
