...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/seed2need-cli.cpp \
           src/seed2need-tx.cpp \
           src/seed2need.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/seed2need.qrc src/qt/seed2need_locale.qrc

TRANSLATIONS += src/qt/locale/seed2need_bg.ts \
                src/qt/locale/seed2need_de.ts \
                src/qt/locale/seed2need_en.ts \
                src/qt/locale/seed2need_es.ts \
                src/qt/locale/seed2need_fi.ts \
                src/qt/locale/seed2need_fr.ts \
                src/qt/locale/seed2need_it.ts \
                src/qt/locale/seed2need_ja.ts \
                src/qt/locale/seed2need_pl.ts \
                src/qt/locale/seed2need_pt.ts \
                src/qt/locale/seed2need_ru.ts \
                src/qt/locale/seed2need_sk.ts \
                src/qt/locale/seed2need_sv.ts \
                src/qt/locale/seed2need_vi.ts \
                src/qt/locale/seed2need_zh_CN.ts \
                src/qt/locale/seed2need_zh_TW.ts
