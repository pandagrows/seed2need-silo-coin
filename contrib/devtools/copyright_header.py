...
# Copyright (c) 2018-2023 The SEED2NEED Core developers
...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The SEED2NEED Core developers",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The SEED2NEED Core developers'
...
CPP_HEADER = '''
// Copyright (c) %s The SEED2NEED Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The SEED2NEED Core developers'
                 % (filename))
