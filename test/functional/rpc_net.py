...
class NetTest(Seed2needTestFramework):
    ...
    def _test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(ipv6_addr, 4820)

        # Add 1,000,000 IPv4 addresses to the address manager. Due to the way bucket
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 4820)
