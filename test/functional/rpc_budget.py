...
class BudgetProposalTest(Seed2needTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid SEED2NEED address")
        assert_raises_rpc_error(-5, "Invalid SEED2NEED address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of %.8f is less than minimum 10 SILO allowed" % invalid_amt, self.nodes[0].preparebudget,
