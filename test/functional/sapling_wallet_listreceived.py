...
class ListReceivedTest (Seed2needTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 SILO.
        ...
        # Send 1 SILO to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 SILO sending them all (fee is 0.1 SILO)
        ...
        # Confirm transaction (2 SILO from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 SILO, send 0.6 SILO + 0.05 SILO fee
