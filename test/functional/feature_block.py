...
# Copyright (c) 2020-2022 The SEED2NEED Core developers
...
class FullBlockTest(Seed2needTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure seed2needd isn't accepting b26
        ...
        # Extend the b28 chain to make sure seed2needd isn't accepting b28
        ...
        # SEED2NEED: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the seed2need code has custom code which does so);
