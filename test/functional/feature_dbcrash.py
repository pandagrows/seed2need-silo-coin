...
class ChainstateWriteCrashTest(Seed2needTestFramework):
    ...
    def set_test_params(self):
        ...
        self.chain_params = ['-nuparams=v5_shield:90000', '-nuparams=SEED2NEED_v4.0:90000',
                             '-nuparams=SEED2NEED_v3.4:90000', '-nuparams=Zerocoin_Public:90000',
    ...
    def restart_node(self, node_index, expected_tip):
        ...
        while time.time() - time_start < 120:
            try:
                ...
                # If seed2needd exits, then try again.  wait_for_node_exit()
                # should raise an exception if seed2needd doesn't exit.
                self.wait_for_node_exit(node_index, timeout=10)
            self.crashed_on_restart += 1
            time.sleep(1)

        # If we got here, seed2needd isn't coming back up on restart.  Could be a
        # bug in seed2needd, or we've gotten unlucky with our dbcrash ratio --
