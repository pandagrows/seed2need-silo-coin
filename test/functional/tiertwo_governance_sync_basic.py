...
from test_framework.test_framework import Seed2needTier2TestFramework
...
class MasternodeGovernanceBasicTest(Seed2needTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.seed2need.org/t/test-proposal"
