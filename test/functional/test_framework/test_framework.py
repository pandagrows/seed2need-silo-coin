...
class Seed2needTestFramework():
    ...
    """
    Create a ProReg tx, which references an 100 SILO UTXO as collateral.
...
class Seed2needDMNTestFramework(Seed2needTestFramework):
...
class Seed2needTier2TestFramework(Seed2needTestFramework):
    ...
    def set_test_params(self):
        ...
        self.extra_args = [["-nuparams=v5_shield:249", "-nuparams=SEED2NEED_v5.5:250", "-nuparams=v6_evo:250", "-whitelist=127.0.0.1"]] * self.num_nodes
