...
COIN = 100000000 # 1 SILO in satoshis
...
# Objects that map to seed2needd objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in seed2needd indicates these should be deserialized as blocks
