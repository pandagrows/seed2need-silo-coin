...
class SaplingFillBlockTest(Seed2needTestFramework):
    ...
    def utxo_splitter(self, node_from, n_inputs, node_to):
        ...
        # split each one in 100 (use fixed 0.05 SILO fee)
        for u in utxos:
    ...
    def run_test(self):
        ...
        # Now alice shields the new utxos individually (fixed 0.2 SILO fee --> ~2.3 SILO notes)
