...
"""Test seed2needd with different proxy configuration.

Test plan:
- Start seed2needd's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on seed2needd side:
...
- Create seed2needds that connect to them
- Manipulate the seed2needds using addnode (onetry) an observe effects
...
class ProxyTest(Seed2needTestFramework):
    ...
    def node_test(self, node, proxies, auth, test_onion=True):
        ...
        # Note: seed2needd's SOCKS5 implementation only sends atyp DOMAINNAME, even if connecting directly to IPv4/IPv6
