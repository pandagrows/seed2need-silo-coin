...
class DIP3Test(Seed2needTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 SILO) to the operator, and (2 * 2.7 SILO) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid SEED2NEED address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid SEED2NEED address InvalidPayee", controller.protx_update_registrar,
