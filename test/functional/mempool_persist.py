...
By default, seed2needd will dump mempool on shutdown and
...
class MempoolPersistTest(Seed2needTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent seed2needd from writing mempool.dat to disk. Verify that `savemempool` fails")
