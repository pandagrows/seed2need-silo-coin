...
Also test that nodes that send unsupported service bits to seed2needd are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if seed2needd ban behavior changes
    def on_open(self):
        super().on_open()
...
class P2PLeakTest(Seed2needTestFramework):
