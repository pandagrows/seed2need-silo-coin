...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "qt/seed2need/addresseswidget -> qt/seed2need/seed2needgui -> qt/seed2need/addresseswidget"
    "qt/seed2need/navmenuwidget -> qt/seed2need/seed2needgui -> qt/seed2need/navmenuwidget"
    "qt/seed2need/seed2needgui -> qt/seed2need/qtutils -> qt/seed2need/seed2needgui"
    "qt/seed2need/qtutils -> qt/seed2need/snackbar -> qt/seed2need/qtutils"
    "sapling/saplingscriptpubkeyman -> wallet/wallet -> sapling/saplingscriptpubkeyman"
    "spork -> sporkdb -> spork"
    "spork -> validation -> spork"
    "txmempool -> validation -> txmempool"
    "validation -> validationinterface -> validation"
    "validation -> zsilo/zsilomodule -> validation"
    "wallet/fees -> wallet/wallet -> wallet/fees"
    "wallet/scriptpubkeyman -> wallet/wallet -> wallet/scriptpubkeyman"
    "wallet/wallet -> wallet/walletdb -> wallet/wallet"
    "wallet/wallet -> zsilochain -> wallet/wallet"
    "zsilo/zsilomodule -> zsilochain -> zsilo/zsilomodule"
    ...
    "qt/askpassphrasedialog -> qt/seed2need/seed2needgui -> qt/seed2need/topbar -> qt/askpassphrasedialog"
    "qt/seed2need/coldstakingwidget -> qt/seed2need/tooltipmenu -> qt/seed2need/seed2needgui -> qt/seed2need/coldstakingwidget"
    "qt/seed2need/masternodeswidget -> qt/seed2need/tooltipmenu -> qt/seed2need/seed2needgui -> qt/seed2need/masternodeswidget"
    "qt/seed2need/seed2needgui -> qt/seed2need/send -> qt/seed2need/tooltipmenu -> qt/seed2need/seed2needgui"
    ...
    "chain -> legacy/stakemodifier -> validation -> zsilochain -> chain"
